...
public class processdata {
	public static void main(String[] args) {
		try {
			String all_xmldir="F:\\yutian\\Datasets\\tournament_part1_8\\tournament_part8";
			String random_xmldir="F:\\yutian\\Datasets\\randomsample";
		...
		try{
			if(allfile.isDirectory()){
				...
				//	if(partfiles.isDirectory()){
						String tracepath=Paths.get(allfile.getPath(), "traces").toString();
